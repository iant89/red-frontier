...
const SAMPLES: Record<SimCommand['type'], SimCommand> = {
  ...
  'policy/stockpile': { type: 'policy/stockpile', on: true, resource: 'ice', minKg: 300 },
  'policy/nightPower': { type: 'policy/nightPower', on: true, minBatteryPct: 40 },
  'policy/stormShelter': { type: 'policy/stormShelter', on: true },
  'policy/autoMaintain': { type: 'policy/autoMaintain', on: true, maxWearPct: 30 },
