...
echo -e "       ${WHITE}./launchers/update_and_build.sh${RESET}   ${DIM}(pulls newest changes and builds to dist/)${RESET}"
echo ""
echo -e "    ${MARS}${BOLD}2. Launch local preview server:${RESET}"
echo -e "       ${WHITE}./launchers/launch_preview.sh${RESET}     ${DIM}(serves production build at http://localhost:4173)${RESET}"
echo ""
