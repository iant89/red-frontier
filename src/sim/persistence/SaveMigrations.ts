 ...
 * the chain v3→v8 and is the only place that knows about old versions.
 */
...
/**
 * Migrate any supported historical save (v3..v7) to current (v8).
 ...
 */
export { migrateV3Save, migrateV4Save, migrateV5Save, migrateV6Save, migrateV7Save };
